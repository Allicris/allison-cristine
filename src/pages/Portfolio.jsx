      ...
      <div className="collaborative-projects">
        <div className="project">
          ...
          <div className="description">
            <p>
              COMING SOON! An Eco-Friendly E-Commerce Store where users can log in and shop for favorite organic foods and eco-friendly products.
            </p>
            <p>
        ...
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              <em>Technologies Used:</em> MERN Stack, JWT, Apollo, GraphQL Bootstrap, Heroku.
            </p>
          </div>
        </div>
        ...
        <div className="project">
          ...
          <img className="images" src={finance} alt="Financial Logging Website" />
          <div className="project-links">
          ...
          <div className="description">
            <p>
              A personal book keeping website where a user can sign in and record their monthly expenses to better budget themselves.{" "}
            </p>
            <p>
              <em>Technologies Used:</em> MERN Stack, Apollo, GraphQL, JWT, Tailwind CSS.
            </p>
          </div>
        </div>
        ...
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              <em>Technologies Used:</em> HTML, CSS, JavaScript, Open Weather API’s.
            </p>
          </div>
        </div>
        ...
        <div className="project">
          ...
          <div className="description">
            <p>
              A timed quiz that can be used to test your knowledge of JavaScript
              concepts and syntax. At the end of the quiz, you will receive a
              score based on how many answers you answered correctly.{" "}
            </p>
            <p>
        ...
        <div className="project">
          ...
          <div className="project-links">
            ...
            <a href="https://priscillasxnails.netlify.app">
              Website Link
            </a>
          </div>
          <div className="description">
